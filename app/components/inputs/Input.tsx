...
import { FieldValues, UseFormRegister, FieldErrors, appendErrors } from 'react-hook-form'
    ...
    return (
        <div className='w-full relative'>
            ...
            <input
                id={id}
                disabled={disabled}
                {...register(id, { required })} // รับค่า register ส่งไปยังform => required formต้องกรอก id
                placeholder=' '
                type={type}
